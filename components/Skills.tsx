...
const containerVariants = {
  ...
  visible: {
    opacity: 1,
    transition: { staggerChildren: 0.1 } // Itt állítod be a sorrendiséget
  }
};
...
export default function Skills() {
  return (
    <section id="skills" className="w-full py-24 flex flex-col justify-center items-center px-6 selection:bg-[#d326d3]/30">
      <div className="w-full max-w-5xl mx-auto">
        
        <div className="text-center mb-16">
          {/* Cím: ez érkezik meg először */}
          <motion.h2 
        ...
        >
          {skills.map((skill, index) => (
            // 3. A linket cseréld motion.a-ra
            <motion.a 
              key={index}
            ...
            >
              ...
              <div className="relative w-12 h-12 p-2.5 z-10 shrink-0">
                <Image src={skill.img} alt={skill.name} fill sizes="48px" className="object-contain" />
              </div>

              <div className="relative z-10">
                <h3 className="text-base font-light text-white tracking-wide">{skill.name}</h3>
                <span className="text-[10px] font-extralight text-white/40 tracking-wider">Learn more →</span>
              </div>
            </motion.a>
          ))}
        </motion.div>
